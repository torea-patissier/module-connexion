...
<footer>
    ...
    $dbco = mysqli_connect('localhost', 'root', '', 'moduleconnexion'); // Etablir la connexion avec mySql
    ...
    if (isset($_POST['sinscrire'])) { // Si on appuie sur Envoyer alors
        ...
        elseif ($_POST['password'] != $_POST['confpass']) { // On vérifie que le MDP est bien le même lors de la confirmation, sinon Echo msg d'erreur
            ...
            $_SESSION['login'] = $_POST['login'];
            header('Location: http://localhost/Travail/module-connexion/connexion/connexion.php'); // Redirection de Inscription vers Connexion
        }
    }
